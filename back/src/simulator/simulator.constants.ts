import { loadRevenuesTreeDependencies } from 'src/utils/simulator';
import { ResourceType, TSimulatorTree } from './simulator.type';

export const TABLE_REVENUES = {
  1: [15000, 25000, 35000],
  2: [20000, 30000, 40000],
  3: [25000, 35000, 45000],
  4: [30000, 40000, 50000],
...
export const HELPS_COLORS: { [key: string]: string } = {
  '1': 'Bleu',
  '2': 'Jaune',
  '3': 'Violet',
  '4': 'Rouge',
...
export const CEE_TABLE = [
  {
    types: [ResourceType.VERY_MODEST, ResourceType.MODEST],
    helps: [
      {
        proId: 1,
        value: 4000,
  ...
  {
    types: [ResourceType.INTERMEDIATE, ResourceType.SUPERIOR],
    helps: [
      {
        proId: 1,
        value: 2500,
...
export const MAPRIMERENOV_TABLE: {
  [key: number]: { proId: number; value: number }[];
} = {
  [ResourceType.VERY_MODEST]: [
    { proId: 1, value: 5000 },
    { proId: 3, value: 1200 },
    { proId: 4, value: 4000 },
    { proId: 5, value: 10000 },
...
export const MAPRIMERENOV_LIMIT = 20000;

export const SIMULATOR_TREE: TSimulatorTree[] = [
  {
    id: 'type-logement',
  ...
  },
  {
    ...
    title:
      'Aujourd’hui, quel est votre mode de chauffage principal pour ce logement ?',
    subtitle:
      ...
      fioul: [
        {
          ...
          subtitle:
            'Pas toujours évident de connaître la différence ! Choisissez "Je ne sais pas" et vous pourrez identifier votre système actuel avec l’aide d\'un conseiller Label Energie.',
          values: [
            {
  ...
  },
  {
    ...
    subtitle:
      'Rassurez-vous, ce choix n’est pas définitif. Vous pourrez en discuter avec un conseiller Label Energie.',
    valuesSection: [
      {
        title: 'Chauffage',
        values: [
  ...
  },
  {
    ...
    subtitle:
      'Pour estimer vos aides, nous avons besoin de connaître votre localisation.',
    type: 'input-address',
    label: 'Adresse',
  },
  {
      ...
      'proprio-second': [
        {
          ...
          subtitle:
            'Le montant des aides dépend aussi du lieu de votre résidence principale.',
          type: 'input-text',
          label: 'Code postal',
        },
      ],
  ...
  },
  {
    ...
    subtitle:
      'Cette information nous permet de vous donner une estimation plus précise de vos aides !',
    type: 'input-moreless',
    dependencies: loadRevenuesTreeDependencies(TABLE_REVENUES),
    idfDependencies: loadRevenuesTreeDependencies(TABLE_REVENUES_IDF),
  },
  {
    id: 'prime-utilisee',
  ...
  },
  {
    ...
    mask: 'XX-XX-XX-XX-XX',
    subtitle:
      'Nous ne réalisons aucun démarchage téléphonique et vous rappelons que, conformément à l’article L.223-2 du Code de la consommation, vous avez le droit de vous inscrire gratuitement sur une liste d’opposition au démarchage téléphonique.',
  },
  {
    id: 'creer-compte',
    type: 'signup',
