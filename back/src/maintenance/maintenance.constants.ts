import { TMaintenanceTree, TProduct } from './maintenance.type';

export function getMaintenanceTree(
  type: string,
  products: TProduct[],
): TMaintenanceTree[] {
  return [
      ...
      items:
        type == 'custom'
          ...
          : [
              ...
              {
                title:
                  'Avez-vous des radiateurs eau chaude et/ou un plancher chauffant raccordés à la pompe à chaleur ?',
                type: 'select',
    ...
    },
    {
      ...
      subtitle:
        'Le rendez-vous vous sera définitivement confirmé par e-mail sous 3 jours ouvrés. Appel du technicien le jour même pour vous préciser son heure d’arrivée.',
      items: [
        {
          type: 'input-date',
          id: 'date',
