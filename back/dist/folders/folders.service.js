...
let FoldersService = class FoldersService {
    ...
    async create(auth, data) {
        try {
            ...
            console.error(...oo_tx(`2537379226_67_6_67_52_11`, 'Error creating folder:', error));
    ...
    async findAll(auth) {
        try {
            ...
            console.error(...oo_tx(`2537379226_82_6_82_53_11`, 'Error fetching folders:', error));
    ...
    async addDocument(auth, id, { files }) {
        try {
            ...
            console.error(...oo_tx(`2537379226_111_6_111_52_11`, 'Error adding document:', error));
    ...
    async completeFolder(auth, id) {
        try {
            ...
            console.error(...oo_tx(`2537379226_126_6_126_54_11`, 'Error completing folder:', error));
    ...
    async updateStatus(auth, id, status) {
        try {
            ...
            console.error(...oo_tx(`2537379226_142_6_142_52_11`, 'Error updating status:', error));
    ...
    async updateNumMPR(auth, id, numMPR) {
        try {
            ...
            console.error(...oo_tx(`2537379226_152_6_152_49_11`, 'Error updating MPR:', error));
    ...
    async updatePdfLink(auth, id, pdfLink) {
        try {
            ...
            console.error(...oo_tx(`2537379226_162_6_162_54_11`, 'Error updating PDF link:', error));
    ...
    async remove(auth, id) {
        try {
            ...
            console.error(...oo_tx(`2537379226_193_6_193_52_11`, 'Error removing folder:', error));
            (0, error_1.throwError)('Error removing folder', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async generatePdf(auth, id) {
        try {
            console.log(...oo_oo(`2537379226_200_6_200_80_4`, '[PDF] Starting generation for folder:', id, 'user:', auth.id));
            const folder = await this.getFolder(auth, id);
            if (!folder) {
            ...
            console.error(...oo_tx(`2537379226_214_6_219_8_11`, '[PDF] Generation failed:', {
                folderId: id,
                userId: auth.id,
                error: error.message,
                stack: error.stack
