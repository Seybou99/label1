...
let PdfService = class PdfService {
    ...
    async generatePdf(folderId, simulationData, userId) {
        try {
            console.log(...oo_oo(`4208318446_227_6_232_8_4`, '[PDF Generation] Starting with data:', {
                folderId,
                userId,
            ...
            try {
                ...
                console.error(...oo_tx(`4208318446_269_8_269_63_11`, '[PDF] URL generation failed:', urlError));
                throw new Error('Failed to generate PDF URL');
            }
        }
        catch (error) {
            console.error(...oo_tx(`4208318446_274_6_279_8_11`, '[PDF Generation] Failed:', {
                error: error.message,
                stack: error.stack,
                folderId,
                userId
        ...
        return new Promise((resolve, reject) => {
            ...
            doc.on('end', async () => {
                try {
                    ...
                    console.error(...oo_tx(`4208318446_427_10_431_12_11`, 'PDF generation failed:', {
                        error: error.message,
                        folderId,
                        userId
                    }));
