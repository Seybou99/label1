...
let MaintenanceService = class MaintenanceService {
    ...
    async storeSignedContract(auth, body) {
        try {
            ...
            console.error(...oo_tx(`2395319994_117_6_117_58_11`, 'Store signed contract error:', error));
            (0, error_1.throwError)('Error storing signed contract', 500);
        }
    }
    ...
    async generateJWTForDocusign() {
        ...
        try {
            ...
            console.error(...oo_tx(`2395319994_179_6_179_72_11`, 'Error fetching access token:', error.response.data));
    ...
    async sendContractForSignature(auth, contractData) {
        try {
            ...
            console.error(...oo_tx(`2395319994_291_6_291_45_11`, 'DocuSign error:', error));
